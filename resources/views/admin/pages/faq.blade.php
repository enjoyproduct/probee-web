                            ...
                            <ul class="icons-list">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="{{URL::to('admin/faq/' . $faq->faq_id . '/edit')}}">Edit</a></li>
                                        <li><a href="{{URL::to('admin/faq/' . $faq->faq_id . '/delete')}}" onclick="return confirm('Do you want to delete this faq?')">Delete</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </td>
