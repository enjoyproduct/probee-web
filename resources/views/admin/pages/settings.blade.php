                            ...
                            <div class="tab-pane active" id="bottom-tab1">
                                <form class="form-horizontal" action="{{URL::to('/admin/setting/'.$setting->admin_id.'/update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-1">Phone number</label>
                                            <div class="col-lg-11">
                                                <input type="text" class="form-control" name="phone_number" placeholder="Input Admin phone number ..."
                                                       value="{{isset($setting->phone_number) ? $setting->phone_number : ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-1">Price per pass</label>
                                            <div class="col-lg-11">
                                                <input type="text" class="form-control" name="price_per_pass" placeholder="Input price ..."
                                                       value="{{isset($setting->price_per_pass) ? $setting->price_per_pass : ''}}">
                                            </div>
                                        </div>
                                    </fieldset>
