        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Support</span></h4>
                </div>
            </div>

            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    <li><a href="{{ URL::to('/admin/support')}}"><i class="icon-home2 position-left"></i>Support</a></li>
                </ul>
                    ...
                    <div class="col-md-8">
                        <div class="panel panel-flat">
                            <div class="panel-body">
                                <form class="form-horizontal" action="@if (isset($support)) {{url('/admin/support/'.$support->contact_id.'/update')}} @endif" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="textarea" class="form-control" name="question" placeholder="Question" value="{{ isset($support) ? $support->question : old('')}}" required>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="textarea" class="form-control" name="answer" placeholder="Answer" value="{{ isset($support) ? $support->answer : old('')}}" required>
